...
:: Android packaging
set AND_CERT_NAME="ParticleDesigner"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\ParticleDesigner.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=cert\Fake.p12
set IOS_DEV_CERT_FILE=cert\Fake.p12
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=ParticleDesigner
