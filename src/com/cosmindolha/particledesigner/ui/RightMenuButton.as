...
//	import starling.text.TextFormat;
	 ...
	 * @author cosmin dolha
	 */
	public class RightMenuButton extends Sprite
	{
		...
		private var id:int;
		public function RightMenuButton(dd:DataDispatcher, iD:int, label:String) 
		{
			dispatcher = dd;
			id = iD;
			sp = new Sprite();
		...
		private function onTouch(e:TouchEvent):void
		{
			...
			if (upTouch != null)
			{
					...
					sendObject.bt = this;
					sendObject.id = id;
					dispatcher.menuClicked(sendObject)
			}
		...
		private function buttonBitmap():Texture
		{
			...
			sp.graphics.beginFill(0xad02c8, .4);
			sp.graphics.drawRoundRect(0, 0,  70, 45, 5, 5);
			sp.graphics.endFill();
