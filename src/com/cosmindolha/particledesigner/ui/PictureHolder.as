package com.cosmindolha.particledesigner.ui 
{
	...
	public class PictureHolder extends Sprite
	{
		...
		public function PictureHolder(dd:DataDispatcher, rs:Resource, id:int, tx:String) 
		{
		...
		private function onTouch(e:TouchEvent):void
		{
			...
			if (upTouch != null)
			{
				...
				dispatcher.picturePicked(sendObject);
			}
